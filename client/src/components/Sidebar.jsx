                            ...
                            return (
                                <NavLink key={index} to={to}>
                                    <li
                                        ...
                                        {!expanded && (
                                            <div className="absolute left-[70px] w-40 rounded-md text-sm text-indigo-700 bg-indigo-100 px-2 py-1 invisible opacity-20 -translate-x-3 transition-all group-hover:visible group-hover:opacity-100 group-hover:translate-x-0">
                                                {item}
                                            </div>
                                        )}
                                    </li>
